create table cam_college
(
    college_id    bigint auto_increment comment '学院id'
        primary key,
    college_name  varchar(30)                        not null comment '学院名称',
    college_money bigint                             null comment '学院金额',
    create_time   datetime default CURRENT_TIMESTAMP null comment '创建时间',
    update_time   datetime default CURRENT_TIMESTAMP null comment '更新时间'
);

create table cam_health
(
    student_id    bigint auto_increment comment '学号'
        primary key,
    student_name  varchar(30)                        null comment '姓名',
    college_name  varchar(30)                        null comment '学院',
    student_class varchar(255)                       null comment '班级',
    punch_time    datetime default CURRENT_TIMESTAMP null comment '打卡时间',
    tiime_part    varchar(255)                       null comment '时间段',
    travel        varchar(255)                       null comment '行程轨迹',
    temperature   varchar(10)                        null comment '体温',
    cough         varchar(5)                         null comment '咳嗽',
    fever         varchar(5)                         null comment '发烧'
);

create table cam_levscl
(
    student_id    bigint                             not null comment '学号'
        primary key,
    student_name  varchar(30)                        null comment '姓名',
    college_name  varchar(30)                        null comment '学院名称',
    student_class varchar(20)                        null comment '班级',
    lev_course    varchar(255)                       null comment '离校原因',
    travel        varchar(255)                       not null comment '行程轨迹',
    lev_time      datetime default CURRENT_TIMESTAMP null comment '离校时间',
    reschool_time datetime default CURRENT_TIMESTAMP null comment '返校时间',
    status        char(2)                            null comment '审批状态'
);
...
(
    ...
    comment '代码生成业务表' auto_increment = 2;
...
(
    ...
    comment '代码生成业务表字段' auto_increment = 2;
...
(
    ...
    comment '参数配置表' auto_increment = 100;
...
(
    ...
    comment '部门表' auto_increment = 200;
...
(
    ...
    comment '字典数据表' auto_increment = 100;
...
(
    ...
    comment '定时任务调度表' auto_increment = 100;
...
(
    ...
    comment '系统访问记录' auto_increment = 107;
...
(
    ...
    comment '菜单权限表' auto_increment = 2000;
...
(
    ...
    comment '通知公告表' auto_increment = 9;
...
(
    ...
    comment '操作日志记录' auto_increment = 104;
...
(
    ...
    comment '岗位信息表' auto_increment = 5;
...
(
    ...
    comment '角色信息表' auto_increment = 100;
...
(
    ...
    comment '用户信息表' auto_increment = 100;
